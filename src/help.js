...
(function() {
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="border border-gray-200 rounded-xl p-3 bg-white shadow-sm flex items-start gap-3 md:col-span-2 border-l-4 border-l-emerald-500 hover:shadow-md transition-shadow">
                                        <div class="mt-0.5"><strong class="text-sm text-gray-800 block flex items-center gap-2">Cross-Side Snapping</strong><span class="text-xs text-gray-500 block leading-relaxed mt-1">Enable this to snap elements on the Front face directly to the calculated bounding boxes of elements on the Back face. Perfect for ensuring that double-sided print graphics overlap perfectly when held up to the light!</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="list-disc pl-5 text-sm text-gray-600 space-y-2">
                                    ...
                                    <li><strong>Element Tagging:</strong> Click the <code class="bg-gray-100 px-1 rounded font-bold border border-gray-200">Tags</code> button on the floating toolbar to assign comma-separated tags to an element. This is extremely useful for Plugins!</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-templates" class="help-tab hidden help-animate-fade-in">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 bg-white shadow-sm">
                                ...
                                <p class="text-sm text-gray-600 mb-3">Use a question mark <code class="bg-gray-100 px-1 rounded text-red-500 font-semibold">?</code> to render different text based on conditionals. You can check for simple existence, or use full JS comparisons (<code class="bg-gray-100 px-1 rounded text-gray-700 font-semibold">===</code>, <code class="bg-gray-100 px-1 rounded text-gray-700 font-semibold">&gt;</code>, <code class="bg-gray-100 px-1 rounded text-gray-700 font-semibold">&lt;</code>).</p>
                                <div class="bg-gray-900 rounded-lg p-3 text-sm font-mono text-gray-300 space-y-2">
                                    <div><span class="text-gray-500">// Simple Truthiness:</span></div>
                                    <div class="text-orange-300">{{IsBoss ? "Warning: Boss Level!", "Standard Enemy"}}</div>
                                    <div class="mt-2"><span class="text-gray-500">// Math / Comparisons:</span></div>
                                    <div class="text-orange-300">{{HP &lt; 5 ? "Low Health!", "Healthy"}}</div>
                                    <div class="text-orange-300">{{Type === "Fire" ? "Super Effective", "Normal"}}</div>
                                    <div class="mt-2"><span class="text-gray-500">// Complex JS (Wrap variables in brackets!):</span></div>
                                    <div class="text-orange-300">{{[HP] > 0 && [Status] !== "Poison" ? "Safe", "Danger"}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const bindHelpMenu = () => {
        ...
        if (infoBtn) {
            // Swap the "i" icon for a "?" icon
            infoBtn.innerHTML = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';
